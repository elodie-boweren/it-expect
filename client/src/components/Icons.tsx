...
export function CircleIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PortalIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <ellipse cx="12" cy="12" rx="9" ry="7" strokeDasharray="3 2" />
...
export function PortalGunIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {/* Gun Barrel & Body */}
      <path d="M2 11h14v5H2z" />
      <path d="M16 12h4v3h-4z" />
      <path d="M20 13h2v1h-2z" />
      {/* Handle */}
      <path d="M6 16v5a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-5" />
      {/* Fluid Bulb on Top */}
      <path d="M8 8a3 3 0 0 1 6 0v3H8V8z" />
...
export function SpaceCruiserIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <line x1="5" y1="14.5" x2="3" y2="17" />
      <line x1="19" y1="14.5" x2="21" y2="17" />
...
export function FlaskIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9 3h6M10 3v5l-6 11a2 2 0 0 0 1.7 3h12.6a2 2 0 0 0 1.7-3L14 8V3" />
      <path d="M6.5 16h11" />
...
export function AtomIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MicroverseBatteryIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Energy core */}
      <path d="M13 8l-3 5h4l-2 5" />
    </svg>
  );
}

export function DimensionRadarIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ZapLaserIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
